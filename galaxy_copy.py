...
ldc_dir = 'LDC/'
config = {'files': {'galaxy_file': galaxy_file, 'galaxy_dir': ldc_dir}, 'iterative_fit_constants': {'fmin_binary': 0.001, 'fmax_binary': 0.00105}}
...
n_dgb_sel = min(100000, n_dgb)
n_igb_sel = min(0, n_igb)
n_vgb_sel = min(0, n_vgb)
...
filename_out = 'Galaxies/Galaxy5/galaxy_binaries.hdf5'
