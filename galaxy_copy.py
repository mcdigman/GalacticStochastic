...
galaxy_file = 'LDC2_sangria_training_v1.h5'
ldc_dir = 'LDC/'
config = {'files': {'galaxy_file': galaxy_file, 'galaxy_dir': ldc_dir}, 'iterative_fit_constants': {'fmin_binary': 1.e-8, 'fmax_binary': 1.0}}
...
n_dgb_sel = min(0, n_dgb)
n_igb_sel = min(0, n_igb)
n_vgb_sel = min(1000000, n_vgb)
...
filename_out = 'Galaxies/GalaxyVerification2LDC/galaxy_binaries.hdf5'
