...
if __name__ == '__main__':
    ...
    config_filename = 'Galaxies/GalaxyFullLDC/run_old_parameters_format4.toml'
    ...
    ifm = fetch_or_run_iterative_loop(config, cyclo_mode=cyclo_mode, fetch_mode=1, output_mode=1, preprocess_mode=0)
