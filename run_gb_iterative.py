...
if __name__ == '__main__':
    ...
    for itrm in range(0, 1):
        ...
        do_hf_out = True
        if do_hf_out:
            gfi.store_processed_gb_file(galaxy_dir, galaxy_file, ifm.wc, ifm.lc, ifm.ic, ifm.noise_manager.nt_min, ifm.noise_manager.nt_max, ifm.bgd, ic.period_list, ifm.bis.n_bin_use, ifm.SAET_m, ifm.noise_manager.SAET_fin, ifm.noise_manager.stat_only, ifm.bis.snrs_tot_upper, ifm.n_full_converged, ifm.bis.argbinmap, ifm.bis.faints_old, ifm.bis.faints_cur, ifm.bis.brights, snr_min_in)
