...
if __name__=='__main__':
    ...
    galactic_bg_const_in,noise_realization_common,snrs_tot_in = gfi.load_master_galactic_file()
    ...
    galactic_bg_const = galactic_bg_const_in.reshape(gfi.global_max_Nt,wc.Nf,wc.NC)[:wc.Nt].reshape(wc.Nt*wc.Nf,wc.NC)
    ...
    do_hf_write = True
    if do_hf_write:
        filename_out = gfi.get_init_filename(snr_thresh,Nf=wc.Nf,Nt=wc.Nt,dt=wc.dt)
