...
if do_2plot:
    ...
    aspect = 'auto'
    im = white_plot_ax(ax[0], r"Constant", (signal_white_resid_const[nt_min:nt_max, :, 0:2]**2).sum(axis=2))
    im = white_plot_ax(ax[1], r"Cyclostationary", (signal_white_resid[nt_min:nt_max, :, 0:2]**2).sum(axis=2))
