...
def get_common_noise_filename(snr_thresh, wc):
    return 'Galaxies/Galaxy1/gb8_full_abbrev_snr='+str(snr_thresh)+'_Nf='+str(wc.Nf)+'_Nt='+str(wc.Nt)+'_dt='+str(wc.dt)+'.hdf5'

def get_init_filename(snr_thresh, wc):
    return 'Galaxies/Galaxy1/gb8_full_abbrev_snr='+str(snr_thresh)+'_Nf='+str(wc.Nf)+'_Nt='+str(wc.Nt)+'_dt='+str(wc.dt)+'.hdf5'

def get_master_filename(snr_thresh, wc):
    return "Galaxies/Galaxy1/gb8_full_abbrev_snr="+str(snr_thresh)+"_Nf="+str(wc.Nf)+"_Nt="+str(wc.Nt)+"_dt="+str(wc.dt)+".hdf5"
...
def get_noise_common(snr_thresh, wc):
    filename_gb_common = get_common_noise_filename(snr_thresh, wc)
...
def load_master_galactic_file(snr_thresh, wc):
    master_gb_filename = get_master_filename(snr_thresh, wc)
...
def load_init_galactic_file(snr_thresh, lc, wc, Nt=-1):
    if Nt == -1:
        Nt = wc.Nt
    filename_gb_init = get_init_filename(snr_thresh, wc)
