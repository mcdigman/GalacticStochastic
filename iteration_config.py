...
def get_iteration_config(config):
    ...
    #TODO also need ways to read in snr_autosuppress, smooth_lengthf, smooth_lengtht

    return IterationConfig(n_iterations, snr_thresh, snr_min, snr_autosuppress, smooth_lengthf, smooth_lengtht)
